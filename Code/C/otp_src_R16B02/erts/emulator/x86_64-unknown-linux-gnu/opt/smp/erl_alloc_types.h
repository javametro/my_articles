 ...
 *       'make_alloc_types' on Tue Mar 25 07:05:49 2014.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (63)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (64)
#define ERTS_ALC_N_MAX_A_STANDARD (102)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (103)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (148)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (149)
...
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (168)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (169)
#define ERTS_ALC_N_MAX_A_BINARY (170)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (171)
#define ERTS_ALC_N_MAX_A_DRIVER (184)

#define ERTS_ALC_N_MAX (184)
...
#define ERTS_ALC_T_EXTRA_ROOT (3475)
...
#define ERTS_ALC_T_MISC_AUX_WORK (6483)
#define ERTS_ALC_T_THR_Q_SL (6611)
#define ERTS_ALC_T_ASYNC (6739)
#define ERTS_ALC_T_XPORTS_LIST (6867)
#define ERTS_ALC_T_T_THR_PRGR_DATA (6995)
#define ERTS_ALC_T_ETHR_SL (7123)
#define ERTS_ALC_T_SL_PTIMER (7251)
#define ERTS_ALC_T_SYS_MSG_Q (7315)
#define ERTS_ALC_T_SL_MPATHS (7507)
#define ERTS_ALC_T_AINFO_REQ (7635)
#define ERTS_ALC_T_SCHED_WTIME_REQ (7763)
#define ERTS_ALC_T_GC_INFO_REQ (7891)
#define ERTS_ALC_T_FD_LIST (8019)
#define ERTS_ALC_T_POLLSET_UPDREQ (8147)
#define ERTS_ALC_T_REG_PROC (8212)
#define ERTS_ALC_T_LINK_LH (8340)
#define ERTS_ALC_T_SUSPEND_MON (8468)
#define ERTS_ALC_T_LL_BIF_TIMER (8596)
#define ERTS_ALC_T_REG_TABLE (8788)
#define ERTS_ALC_T_FUN_TABLE (8932)
#define ERTS_ALC_T_DIST_TABLE (9044)
#define ERTS_ALC_T_NODE_TABLE (9172)
#define ERTS_ALC_T_MODULE_REFS (9316)
#define ERTS_ALC_T_DCACHE (9428)
#define ERTS_ALC_T_DIST_ENTRY (9556)
#define ERTS_ALC_T_NODE_ENTRY (9684)
#define ERTS_ALC_T_ARG_REG (9748)
#define ERTS_ALC_T_PROC_DICT (9876)
#define ERTS_ALC_T_CALLS_BUF (10004)
#define ERTS_ALC_T_BPD (10196)
#define ERTS_ALC_T_LINEBUF (10324)
#define ERTS_ALC_T_IOQ (10452)
#define ERTS_ALC_T_BITS_BUF (10580)
#define ERTS_ALC_T_DB_NTAB_ENT (10660)
#define ERTS_ALC_T_DDLL_HANDLE (10836)
#define ERTS_ALC_T_NODES_MON (10900)
#define ERTS_ALC_T_RE_HEAP (11092)
#define ERTS_ALC_T_PSD (11156)
#define ERTS_ALC_T_PRTSD (11348)
#define ERTS_ALC_T_ZLIB (11476)
#define ERTS_ALC_T_PORT_DATA_HEAP (11604)
#define ERTS_ALC_T_THR_Q_EL (11732)
#define ERTS_ALC_T_THR_Q (11860)
#define ERTS_ALC_T_PORT_LOCK (11988)
#define ERTS_ALC_T_DRIVER_LOCK (12116)
#define ERTS_ALC_T_ETHR_STD (12244)
#define ERTS_ALC_T_LL_PTIMER (12372)
#define ERTS_ALC_T_DDLL_PROCESS (12500)
#define ERTS_ALC_T_MONITOR_LH (12564)
#define ERTS_ALC_T_NLINK_LH (12692)
#define ERTS_ALC_T_DB_HEIR_DATA (12836)
#define ERTS_ALC_T_FD_ENTRY_BUF (13012)
#define ERTS_ALC_T_PRT_REP_EXIT (13140)
#define ERTS_ALC_T_ATOM (13253)
#define ERTS_ALC_T_MODULE (13413)
#define ERTS_ALC_T_FUN_ENTRY (13541)
#define ERTS_ALC_T_ATOM_TXT (13637)
#define ERTS_ALC_T_BIF_TIMER_TABLE (13781)
#define ERTS_ALC_T_ATOM_TABLE (13893)
#define ERTS_ALC_T_EXPORT_TABLE (14053)
#define ERTS_ALC_T_MODULE_TABLE (14181)
#define ERTS_ALC_T_TAINT (14309)
#define ERTS_ALC_T_PROC_TABLE (14357)
#define ERTS_ALC_T_PORT_TABLE (14549)
#define ERTS_ALC_T_TIMER_WHEEL (14677)
#define ERTS_ALC_T_ASYNC_DATA (14805)
#define ERTS_ALC_T_DB_TABLES (14885)
#define ERTS_ALC_T_INSTR_INFO (15061)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (15189)
#define ERTS_ALC_T_RUNQS (15317)
#define ERTS_ALC_T_DDLL_ERRCODES (15445)
#define ERTS_ALC_T_PRE_ALLOC_DATA (15573)
#define ERTS_ALC_T_CPUDATA (15701)
#define ERTS_ALC_T_CPU_GRPS_MAP (15829)
#define ERTS_ALC_T_AUX_WORK_TMO (15957)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (16085)
#define ERTS_ALC_T_PROC_INTERVAL (16213)
#define ERTS_ALC_T_THR_Q_LL (16341)
#define ERTS_ALC_T_PROC_LCK_WTR (16469)
#define ERTS_ALC_T_RUNQ_BLNS (16597)
#define ERTS_ALC_T_THR_PRGR_IDATA (16725)
#define ERTS_ALC_T_THR_PRGR_DATA (16853)
#define ERTS_ALC_T_ETHR_LL (16981)
#define ERTS_ALC_T_FP_EXCEPTION (17109)
#define ERTS_ALC_T_LL_MPATHS (17237)
#define ERTS_ALC_T_CODE (17381)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (17445)
#define ERTS_ALC_T_SCHDLR_DATA (17621)
#define ERTS_ALC_T_LL_TEMP_TERM (17749)
#define ERTS_ALC_T_EXPORT (17893)
#define ERTS_ALC_T_DRV_TAB (18005)
#define ERTS_ALC_T_DRV_EV_STATE (18133)
#define ERTS_ALC_T_POLLSET (18261)
#define ERTS_ALC_T_POLL_FDS (18389)
#define ERTS_ALC_T_POLL_RES_EVS (18517)
#define ERTS_ALC_T_FD_STATUS (18645)
#define ERTS_ALC_T_SELECT_FDS (18773)
#define ERTS_ALC_T_FD_TAB (18901)
#define ERTS_ALC_T_CS_PROG_PATH (19029)
#define ERTS_ALC_T_BEAM_REGISTER (19094)
#define ERTS_ALC_T_HEAP (19222)
#define ERTS_ALC_T_OLD_HEAP (19350)
#define ERTS_ALC_T_HEAP_FRAG (19478)
#define ERTS_ALC_T_DB_TABLE (19623)
#define ERTS_ALC_T_DB_SEG (19751)
#define ERTS_ALC_T_DB_SEG_TAB (19879)
#define ERTS_ALC_T_DB_STK (20007)
#define ERTS_ALC_T_DB_TRANS_TAB (20135)
#define ERTS_ALC_T_DB_SEL_LIST (20263)
#define ERTS_ALC_T_DB_DMC_ERROR (20391)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (20519)
#define ERTS_ALC_T_DB_TERM (20647)
#define ERTS_ALC_T_PROC (20760)
#define ERTS_ALC_T_MSG_REF (20888)
#define ERTS_ALC_T_THR_Q_EL_SL (21080)
#define ERTS_ALC_T_MONITOR_SH (21144)
#define ERTS_ALC_T_NLINK_SH (21272)
#define ERTS_ALC_T_DRV_EV_D_STATE (21464)
#define ERTS_ALC_T_DRV_SEL_D_STATE (21592)
#define ERTS_ALC_T_DRV_BINARY (21689)
#define ERTS_ALC_T_BINARY (21817)
#define ERTS_ALC_T_PORT (21978)
#define ERTS_ALC_T_DRV (22106)
#define ERTS_ALC_T_DRIVER (22234)
#define ERTS_ALC_T_DRV_CMD_DATA (22362)
#define ERTS_ALC_T_DRV_CTRL_DATA (22490)
#define ERTS_ALC_T_DRV_CALL_DATA (22618)
#define ERTS_ALC_T_NIF (22746)
#define ERTS_ALC_T_PORT_DATA_LOCK (22874)
#define ERTS_ALC_T_DRV_THR_OPTS (23002)
#define ERTS_ALC_T_DRV_TID (23130)
#define ERTS_ALC_T_DRV_MTX (23258)
#define ERTS_ALC_T_DRV_CND (23386)
#define ERTS_ALC_T_DRV_RWLCK (23514)
#define ERTS_ALC_T_DRV_TSD (23642)
