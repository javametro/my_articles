 ...
 *       'make_alloc_types' on Tue Mar 25 07:05:22 2014.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (56)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (57)
#define ERTS_ALC_N_MAX_A_STANDARD (91)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (92)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (131)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (132)
#define ERTS_ALC_N_MAX_A_EHEAP (135)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (136)
#define ERTS_ALC_N_MAX_A_ETS (144)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (145)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (150)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (151)
#define ERTS_ALC_N_MAX_A_BINARY (152)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (153)
#define ERTS_ALC_N_MAX_A_DRIVER (170)

#define ERTS_ALC_N_MAX (170)
...
#define ERTS_ALC_T_THR_Q_SL (6483)
#define ERTS_ALC_T_ETHR_SL (6611)
#define ERTS_ALC_T_AINFO_REQ (6739)
#define ERTS_ALC_T_SCHED_WTIME_REQ (6867)
#define ERTS_ALC_T_GC_INFO_REQ (6995)
#define ERTS_ALC_T_FD_LIST (7123)
#define ERTS_ALC_T_POLLSET_UPDREQ (7251)
#define ERTS_ALC_T_REG_PROC (7316)
#define ERTS_ALC_T_LINK_LH (7444)
#define ERTS_ALC_T_SUSPEND_MON (7572)
#define ERTS_ALC_T_LL_BIF_TIMER (7700)
#define ERTS_ALC_T_REG_TABLE (7892)
#define ERTS_ALC_T_FUN_TABLE (8036)
#define ERTS_ALC_T_DIST_TABLE (8148)
#define ERTS_ALC_T_NODE_TABLE (8276)
#define ERTS_ALC_T_MODULE_REFS (8420)
#define ERTS_ALC_T_DCACHE (8532)
#define ERTS_ALC_T_DIST_ENTRY (8660)
#define ERTS_ALC_T_NODE_ENTRY (8788)
#define ERTS_ALC_T_ARG_REG (8852)
#define ERTS_ALC_T_PROC_DICT (8980)
#define ERTS_ALC_T_CALLS_BUF (9108)
#define ERTS_ALC_T_BPD (9300)
...
#define ERTS_ALC_T_DDLL_HANDLE (9940)
...
#define ERTS_ALC_T_PORT_DATA_HEAP (10708)
#define ERTS_ALC_T_THR_Q (10836)
#define ERTS_ALC_T_ETHR_STD (10964)
#define ERTS_ALC_T_DDLL_PROCESS (11092)
#define ERTS_ALC_T_MONITOR_LH (11156)
#define ERTS_ALC_T_NLINK_LH (11284)
#define ERTS_ALC_T_DB_HEIR_DATA (11428)
#define ERTS_ALC_T_FD_ENTRY_BUF (11604)
#define ERTS_ALC_T_PRT_REP_EXIT (11732)
#define ERTS_ALC_T_ATOM (11845)
#define ERTS_ALC_T_MODULE (12005)
#define ERTS_ALC_T_FUN_ENTRY (12133)
#define ERTS_ALC_T_ATOM_TXT (12229)
#define ERTS_ALC_T_BIF_TIMER_TABLE (12373)
#define ERTS_ALC_T_ATOM_TABLE (12485)
#define ERTS_ALC_T_EXPORT_TABLE (12645)
#define ERTS_ALC_T_MODULE_TABLE (12773)
#define ERTS_ALC_T_TAINT (12901)
#define ERTS_ALC_T_PROC_TABLE (12949)
#define ERTS_ALC_T_PORT_TABLE (13141)
#define ERTS_ALC_T_TIMER_WHEEL (13269)
#define ERTS_ALC_T_ASYNC_DATA (13397)
#define ERTS_ALC_T_DB_TABLES (13477)
#define ERTS_ALC_T_INSTR_INFO (13653)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (13781)
#define ERTS_ALC_T_RUNQS (13909)
#define ERTS_ALC_T_DDLL_ERRCODES (14037)
#define ERTS_ALC_T_PRE_ALLOC_DATA (14165)
#define ERTS_ALC_T_CPUDATA (14293)
#define ERTS_ALC_T_CPU_GRPS_MAP (14421)
#define ERTS_ALC_T_AUX_WORK_TMO (14549)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (14677)
#define ERTS_ALC_T_PROC_INTERVAL (14805)
#define ERTS_ALC_T_THR_Q_LL (14933)
#define ERTS_ALC_T_ETHR_LL (15061)
#define ERTS_ALC_T_CODE (15205)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (15269)
#define ERTS_ALC_T_SCHDLR_DATA (15445)
#define ERTS_ALC_T_LL_TEMP_TERM (15573)
#define ERTS_ALC_T_EXPORT (15717)
#define ERTS_ALC_T_DRV_TAB (15829)
#define ERTS_ALC_T_DRV_EV_STATE (15957)
#define ERTS_ALC_T_POLLSET (16085)
#define ERTS_ALC_T_POLL_FDS (16213)
#define ERTS_ALC_T_POLL_RES_EVS (16341)
#define ERTS_ALC_T_FD_STATUS (16469)
#define ERTS_ALC_T_SELECT_FDS (16597)
#define ERTS_ALC_T_FD_TAB (16725)
#define ERTS_ALC_T_CS_PROG_PATH (16853)
#define ERTS_ALC_T_BEAM_REGISTER (16918)
#define ERTS_ALC_T_HEAP (17046)
#define ERTS_ALC_T_OLD_HEAP (17174)
#define ERTS_ALC_T_HEAP_FRAG (17302)
#define ERTS_ALC_T_DB_TABLE (17447)
#define ERTS_ALC_T_DB_SEG (17575)
#define ERTS_ALC_T_DB_SEG_TAB (17703)
#define ERTS_ALC_T_DB_STK (17831)
#define ERTS_ALC_T_DB_TRANS_TAB (17959)
#define ERTS_ALC_T_DB_SEL_LIST (18087)
#define ERTS_ALC_T_DB_DMC_ERROR (18215)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (18343)
#define ERTS_ALC_T_DB_TERM (18471)
#define ERTS_ALC_T_PROC (18584)
#define ERTS_ALC_T_MSG_REF (18712)
#define ERTS_ALC_T_MONITOR_SH (18840)
#define ERTS_ALC_T_NLINK_SH (18968)
#define ERTS_ALC_T_DRV_EV_D_STATE (19160)
#define ERTS_ALC_T_DRV_SEL_D_STATE (19288)
#define ERTS_ALC_T_DRV_BINARY (19385)
#define ERTS_ALC_T_BINARY (19513)
#define ERTS_ALC_T_PORT (19674)
#define ERTS_ALC_T_DRV (19802)
#define ERTS_ALC_T_DRIVER (19930)
#define ERTS_ALC_T_DRV_CMD_DATA (20058)
#define ERTS_ALC_T_DRV_CTRL_DATA (20186)
#define ERTS_ALC_T_DRV_CALL_DATA (20314)
#define ERTS_ALC_T_NIF (20442)
#define ERTS_ALC_T_PORT_DATA_LOCK (20570)
#define ERTS_ALC_T_DRV_THR_OPTS (20698)
#define ERTS_ALC_T_DRV_TID (20826)
#define ERTS_ALC_T_DRV_MTX (20954)
#define ERTS_ALC_T_DRV_CND (21082)
#define ERTS_ALC_T_DRV_RWLCK (21210)
#define ERTS_ALC_T_DRV_TSD (21338)
#define ERTS_ALC_T_THR_Q_EL (21466)
#define ERTS_ALC_T_THR_Q_EL_SL (21594)
#define ERTS_ALC_T_MISC_AUX_WORK (21722)
#define ERTS_ALC_T_ASYNC (21850)
